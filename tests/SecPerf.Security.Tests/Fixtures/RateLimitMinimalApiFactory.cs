...
/// <summary>
/// WebApplicationFactory for Minimal API with rate limiting enabled.
/// Uses a low login limit (5 req/s) so the 429 test is fast and deterministic.
/// </summary>
public class RateLimitMinimalApiFactory : WebApplicationFactory<SecPerf.ApiMinimal.MinimalApiMarker>
{
    private static readonly string _dbName = "TestDb_RateLimit_Minimal_" + Guid.NewGuid().ToString("N");
